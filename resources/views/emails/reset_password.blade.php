<div class="row">
    <div class="col-md-4 mx-auto shadow bg-white px-3 pt-3">
        ...
        <p class="text-dark message">we have received a request to reset your password if you didnot make this request
            ,just ignore this email Otherwise you can reset your using the following code.</p>
